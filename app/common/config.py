...
# 服务器地址（支持通过环境变量 OLIB_PROD_HOST / OLIB_TEST_HOST / OLIB_DEV_HOST 覆盖）
import os as _os
PRODHOST = _os.getenv("OLIB_PROD_HOST", "")  # 打包发布前必须配置，或由用户/运维注入
DEVHOST = _os.getenv("OLIB_DEV_HOST", "127.0.0.1:8000")
TESTHOST = _os.getenv("OLIB_TEST_HOST", "")
